...
<body>
  ...
  <section class="backimg ns" style="height :50vh;  no-repeat center;overflow-x:hidden;overflow-y:hidden;">


    <div class = "row justify-content-center"style="text-align:center;padding-top:2%;">
      <img class = "col-6 col-md-3" src = "./pictures/graVITas.png">
    </div>
    <!--<div  align = "center">
